...
//    }
    ...
    @GetMapping("/bookmark")
    public ResponseEntity<List<Map<String, Object>>> getBookmark(@RequestParam(required = false) Long page,
        ...
        List<Map<String, Object>> bookmarkList = userService.getBookmark(username, offset, limit);
